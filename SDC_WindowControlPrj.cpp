...
// SDC_WindowControlPrj.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CSDC_WindowControlPrjApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CSDC_WindowControlPrjApp 생성

CSDC_WindowControlPrjApp::CSDC_WindowControlPrjApp()
{
	// 다시 시작 관리자 지원
...
// 유일한 CSDC_WindowControlPrjApp 개체입니다.

CSDC_WindowControlPrjApp theApp;


// CSDC_WindowControlPrjApp 초기화

BOOL CSDC_WindowControlPrjApp::InitInstance()
{
	...
	CreateMutex(NULL,FALSE, _T("SDC_WindowControlPrj.exe"));
	if(GetLastError() == ERROR_ALREADY_EXISTS)
	{
		AfxMessageBox(_T("The SDC_WindowControlPrj program is already the execution."));
		return FALSE;
	}
