...
#include "resource.h"
//}}AFX_INCLUDES
#if !defined(AFX_GETTEXTDLG_H__2DCECE2D_026B_45B0_BD81_51D582C2AD25__INCLUDED_)
#define AFX_GETTEXTDLG_H__2DCECE2D_026B_45B0_BD81_51D582C2AD25__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// CGetTextDlg.h : header file
//
...
public:
	...
	CGetTextDlg(int maxchar = 20, char* getnum = "", char* title = "Input the Value.", CWnd* pParent = NULL,
			     BOOL pwd = FALSE, BOOL btndisable = FALSE);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CGetTextDlg)
	enum { IDD = IDD_TEXT_BOX };
